...
import grami.dijkstra.DijkstraEngine;
import grami.utilities.CombinationGenerator;
import grami.utilities.Settings;


public class GraMiGraph 
{
	...
	public GraMiGraph(int ID, int freqThresh) 
	{
	...
	/**
	 * 
	 * Added by Yunior Ramírez-Cruz, 21/05/2019
	 * 
	...
	public void cloneJGraphTUndirectedGraph(UndirectedGraph<String, DefaultEdge> jgraphtGraph) { 
		
		int numberOfNodes = 0;   // Code taken verbatim from implementation of loadFromFile

		// Fix an order in vertices of jgraphtGraph 
		ArrayList<String> vertList = new ArrayList<>(jgraphtGraph.vertexSet());
		...
		nodeCount = numberOfNodes;   // Code taken verbatim from implementation of loadFromFile
		
		// "Load" edges
		for (int i = 0; i < vertList.size() - 1; i++)
			for (int j = i + 1; j < vertList.size(); j++)
				if (jgraphtGraph.containsEdge(vertList.get(i), vertList.get(j))) {
					//////////////////////////////////////////////////////////
					// Taken from implementation of loadFromFile and adapted
					final int index1 = i;
					final int index2 = j;
					final double label = 1d;   // We have no edge labels
					addEdge(index1, index2, label);
					//////////////////////////////////////////////////////////
				}
		
		////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		// From here on, we kept the rest of the implementation of loadFromFile verbatim
