...
public class CommunityBasedUtilitiesSNAP {
	...
	public static void main(String [] args) throws IOException {
		...
		/*
		System.out.println("======================================================");
		System.out.println("CODA, inbound:");
		System.out.println("");
				
		HashSet<HashSet<String>> unionCoDAInboundCommunitiesFacebook = new HashSet<>();
		...
		for (String enId : egoNetworkIds) {
			HashSet<HashSet<String>> goldStandardCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\Users\\yunior.ramirez\\workspace\\graph-anonymity\\facebook\\facebook\\" + enId + ".circles.nocid", true);
			HashSet<HashSet<String>> codaInCommunitiesFacebook = null;
			if (numberCiclesGiven)   // Load communities computed with the number of circles given to the algorithm
				codaInCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ego-network-" + enId + "-original-cmtyvv.in.txt", true);
			else   // Load communities computed allowing the algorithm to determine the number of communities
				codaInCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ccng-ego-network-" + enId + "-original-cmtyvv.in.txt", true);
			unionCoDAInboundCommunitiesFacebook.addAll(codaInCommunitiesFacebook);
			
			double f1Orig = utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFacebook, codaInCommunitiesFacebook);
			f1Values.put(enId, f1Orig);
			System.out.println("Original " + enId + ": " + f1Orig);
			
			for (String avId : anonymousVersions) {
				HashSet<HashSet<String>> codaInCommunitiesAnonFacebook = null;
				if (numberCiclesGiven)   // Load communities computed with the number of circles given to the algorithm
					codaInCommunitiesAnonFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ego-network-" + enId + "-anonymized-" + avId + "-cmtyvv.in.txt", true);
				else   // Load communities computed allowing the algorithm to determine the number of communities
					codaInCommunitiesAnonFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ccng-ego-network-" + enId + "-anonymized-" + avId + "-cmtyvv.in.txt", true);
				double f1Anon = utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFacebook, codaInCommunitiesAnonFacebook);
				System.out.println("Anon. ver. " + avId + " " + enId + ": " + f1Anon);
				System.out.println("\tF1: " + f1Anon);
				System.out.println("\tUtility (ratio): " + f1Anon / f1Orig);
				ratios.get(avId).put(enId, f1Anon / f1Orig);
		...
		System.out.println("");
		System.out.println("F1 comparing the union of circles with the union of the algorithm output: " + utilityComputer.twoWayAveragedF1(unionGoldStandardCommunitiesFacebook, unionCoDAInboundCommunitiesFacebook));
		
		System.out.println("");
		System.out.println("Community detection on the full Facebook graph");
		//HashSet<HashSet<String>> goldStandardCommunitiesFullFacebook = utilityComputer.readCommunitiesFromOutput("C:\\Users\\yunior.ramirez\\workspace\\graph-anonymity\\facebook-circles.txt", true);
		HashSet<HashSet<String>> codaInCommunitiesFullFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\facebook-replication-exp-full-original-cmtyvv.in.txt", true);
		System.out.println("Score: " + utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFullFacebook, codaInCommunitiesFullFacebook));//*/
		
		
		/*
		System.out.println("======================================================");
		System.out.println("CODA, outbound:");
		System.out.println("");
				
		HashSet<HashSet<String>> unionCoDAOutboundCommunitiesFacebook = new HashSet<>();
		...
		for (String enId : egoNetworkIds) {
			HashSet<HashSet<String>> goldStandardCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\Users\\yunior.ramirez\\workspace\\graph-anonymity\\facebook\\facebook\\" + enId + ".circles.nocid", true);
			HashSet<HashSet<String>> codaOutCommunitiesFacebook = null;
			if (numberCiclesGiven)   // Load communities computed with the number of circles given to the algorithm
				codaOutCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ego-network-" + enId + "-original-cmtyvv.out.txt", true);
			else   // Load communities computed allowing the algorithm to determine the number of communities
				codaOutCommunitiesFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ccng-ego-network-" + enId + "-original-cmtyvv.out.txt", true);
			unionCoDAOutboundCommunitiesFacebook.addAll(codaOutCommunitiesFacebook);
			
			double f1Orig = utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFacebook, codaOutCommunitiesFacebook);
			f1Values.put(enId, f1Orig);
			System.out.println("Original " + enId + ": " + f1Orig);
			
			for (String avId : anonymousVersions) {
				HashSet<HashSet<String>> codaOutCommunitiesAnonFacebook = null;
				if (numberCiclesGiven)   // Load communities computed with the number of circles given to the algorithm
					codaOutCommunitiesAnonFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ego-network-" + enId + "-anonymized-" + avId + "-cmtyvv.out.txt", true);
				else   // Load communities computed allowing the algorithm to determine the number of communities
					codaOutCommunitiesAnonFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\ego-networks\\facebook-replication-exp-ccng-ego-network-" + enId + "-anonymized-" + avId + "-cmtyvv.out.txt", true);
				double f1Anon = utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFacebook, codaOutCommunitiesAnonFacebook);
				System.out.println("Anon. ver. " + avId + " " + enId + ": " + f1Anon);
				System.out.println("\tF1: " + f1Anon);
				System.out.println("\tUtility (ratio): " + f1Anon / f1Orig);
				ratios.get(avId).put(enId, f1Anon / f1Orig);
		...
		System.out.println("");
		System.out.println("F1 comparing the union of circles with the union of the algorithm output: " + utilityComputer.twoWayAveragedF1(unionGoldStandardCommunitiesFacebook, unionCoDAOutboundCommunitiesFacebook));
		
		System.out.println("");
		System.out.println("Community detection on the full Facebook graph");
		//HashSet<HashSet<String>> goldStandardCommunitiesFullFacebook = utilityComputer.readCommunitiesFromOutput("C:\\Users\\yunior.ramirez\\workspace\\graph-anonymity\\facebook-circles.txt", true);
		HashSet<HashSet<String>> codaOutCommunitiesFullFacebook = utilityComputer.readCommunitiesFromOutput("C:\\cygwin64\\home\\yunior.ramirez\\graph-anonymity\\Snap-3.0\\examples\\coda\\outputs\\facebook-replication-exp-full-original-cmtyvv.out.txt", true);
		System.out.println("Score: " + utilityComputer.twoWayAveragedF1(goldStandardCommunitiesFullFacebook, codaOutCommunitiesFullFacebook));//*/
